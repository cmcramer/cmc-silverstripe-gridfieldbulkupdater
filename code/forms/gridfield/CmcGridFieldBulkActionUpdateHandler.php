 ...
 */
class GridFieldBulkActionUpdateHandler extends GridFieldBulkActionHandler
{	
	/**
	 * RequestHandler allowed actions
	 * @var array
	 */
	private static $allowed_actions = array('columnedit');
	 ...
	 */
	public function columnedit(SS_HTTPRequest $request)
	{
		$ids = array();
